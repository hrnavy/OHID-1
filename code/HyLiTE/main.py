...
parser.add_argument('--dataset', choices=['Indian', 'Pavia', 'Houston','Salinas','hanchuan','longkou','honghu','ohid1-10','india'], default='Indian', help='dataset to use')
...
if args.dataset == 'Indian':
    ...
    data = loadmat('/home/storage/Dataset/WHU-Hi-HanChuan/WHU_Hi_HanChuan.mat')
    gt = loadmat('/home/storage/Dataset/WHU-Hi-HanChuan/WHU_Hi_HanChuan_gt.mat')['WHU_Hi_HanChuan_gt']
elif args.dataset == 'longkou':
    data = loadmat('/home/storage/Dataset/WHU-Hi-HanChuan/WHU_Hi_LongKou.mat')
    gt = loadmat('/home/storage/Dataset/WHU-Hi-HanChuan/WHU_Hi_LongKou_gt.mat')['WHU_Hi_LongKou_gt']
elif args.dataset == 'honghu':
    data = loadmat('/home/storage/Dataset/WHU-Hi-HanChuan/WHU_Hi_HongHu.mat')
    gt = loadmat('/home/storage/Dataset/WHU-Hi-HanChuan/WHU_Hi_HongHu_gt.mat')['WHU_Hi_HongHu_gt']
elif args.dataset == 'ohid1-10':
    data = loadmat('/home/storage/Dataset/OHID/OHID/images/mat/201912_10.mat')
    gt = loadmat('/home/storage/Dataset/OHID/OHID/labels/mat/201912_10.mat')['gt']
elif args.dataset == 'india':
    data = loadmat('data/Indian_pines.mat')
...
i,j = np.nonzero(gt)
te = gt.copy()
ix = np.random.choice(len(i), int(np.floor(0.2 * len(i))), replace=False)# choose train_num or test_num by change the np.random.choice's second parameters
#print(len(ix))
for pos in range(len(ix)):
    te[i[ix[pos]],j[ix[pos]]] = 0
tr = np.subtract(gt,te)
...
TE = te#data['TE']
#print(data)
input = data['input']#need change depends on which dataset you use
