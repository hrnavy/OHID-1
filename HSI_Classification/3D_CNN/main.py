...
parser = argparse.ArgumentParser(description='3D CNN for hyperspectral image classification')
...
parser.add_argument('--data_name',dest='data_name',default='WHU_Hi_LongKou')#dftc
parser.add_argument('--data_path',dest='data_path',default="/home/cx")
